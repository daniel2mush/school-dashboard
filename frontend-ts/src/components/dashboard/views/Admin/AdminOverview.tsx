...
import { type ReactNode, CSSProperties, useState, useEffect } from 'react'
import {
  ResponsiveContainer,
  PieChart,
  Pie,
          ...
          <div className={styles.heroInner}>
            ...
            <div className={styles.heroActions}>
              ...
              <button
                  type="button"
                  className="btn"
                  onClick={() => navigate({ to: '/dashboard/yeargroups' })}
              >
              <span
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}
              >
              ...
              <button
                  type="button"
                  className="btn"
                  onClick={() => navigate({ to: '/dashboard/curriculum' })}
              >
              <span
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}
              >
        ...
        <div className={styles.mainGrid}>
          <Card style={{ marginBottom: 0 }}>
            <CardHeader
                ...
                action="Manage all"
                onAction={() => navigate({ to: '/dashboard/yeargroups' })}
            />
            {!structure?.length ? (
          ...
          <div className={styles.sideStack}>
            <Card style={{ marginBottom: 0 }}>
              <CardHeader
                  ...
                  action="Open hub"
                  onAction={() => navigate({ to: '/dashboard/announcements' })}
              />
