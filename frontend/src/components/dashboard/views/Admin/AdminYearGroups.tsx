...
import { useGetSchoolStructure, useGetAllUsers } from "@/query/AdminQuery";
            ...
            <article key={yg.id} className={styles.card}>
              ...
              <div className={styles.statsRow}>
                <div className={styles.statBlock}>
                  ...
                  />
                  <div>
                    <div className={styles.statValue}>{yg._count.students}</div>
                ...
                <div className={styles.statBlock}>
                  ...
                  />
                  <div>
                    <div className={styles.statValue}>{yg._count.teachers}</div>
                ...
                <div className={styles.statBlock}>
                  ...
                  />
                  <div>
                    <div className={styles.statValue}>{yg.subjects.length}</div>
