...
export function AdminAttendance() {
  ...
  const saveModalAttendance = () => {
    if (modalStudent) {
      console.log(modalStudent.id, modalStatus, modalDate)
      submitAttendance(
        {
  ...
  if (isLoading || !stats) {
    return (
      <div className={styles.loadingState}>{t('admin.attendance.loading')}</div>
    )
  }
    ...
    <div className={styles.view}>
      <header className={styles.header}>
        <div className={styles.headerLeft}>
          <div className={styles.eyebrow}>{t('admin.attendance.eyebrow')}</div>
          <h2 className={styles.title}>{t('admin.attendance.title')}</h2>
        </div>
              ...
              <div className={styles.registryHeader}>
                <div className={styles.registryTitleBlock}>
                  <div className={styles.registryLabel}>
                    {t('admin.attendance.studentRegistry')}
                  </div>
                  <div className={styles.registryCopy}>
                    {t('admin.attendance.registryDescription')}
                  </div>
                </div>
                <div className={styles.registryActions}>
                  <div className={styles.search}>
                    ...
                    <input
                      type="text"
                      placeholder={t('admin.attendance.findStudent')}
                      value={searchTerm}
                    ...
                    >
                      {yearGroups.map((yg) => (
                        <option key={yg} value={yg}>
                          {yg === 'All' ? t('admin.attendance.all') : yg}
                        </option>
                      ))}
                    </select>
                  </div>
            ...
            >
              {selectedStudent ? (
                ...
                <div className={styles.noSelection}>
                  ...
                  <p>{t('admin.attendance.selectStudent')}</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className={styles.markSection}>
          <div className={styles.markHeader}>
            <div className={styles.markControls}>
              ...
              <div className={styles.inputGroup}>
                <label>{t('admin.attendance.filterCohort')}</label>
                <select
                  value={yearGroupFilter}
                  onChange={(e) => setYearGroupFilter(e.target.value)}
                >
